...
#ifndef _CALL_WM_ISI_H
#define _CALL_WM_ISI_H
...
#define MODEM_CALL_ISI_VERSION_Y  10
#endif
...
#define CALL_MODEM_NBR_TYPE_DEDICATED            0x40  /* -100---- */
